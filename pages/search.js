...
export default function SearchScreen() {
  ...
  const [brands,setBrand]=useState(['boat','samsung','apple','sony','ptron','jbl','mivi','zebronics','bose','oneplus','realme']);
  useEffect(() => {
    ...
    fetchData();
  }, [category, price, query, rating, sort,brand]);

  const filterSearch = ({ category, sort, searchQuery, price, rating,brand }) => {
        ...
        <Grid item md={3}>
          ...
          <ListItem>
              <Box sx={classes.fullWidth}>
                ...
                <Select fullWidth value={brand} onChange={bransHandler}>
